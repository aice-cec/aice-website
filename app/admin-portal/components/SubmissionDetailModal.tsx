    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#070709]/85 backdrop-blur-sm overflow-y-auto">
      <div className="w-full max-w-2xl max-h-[90vh] flex flex-col bg-[#121217] border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between p-5 border-b border-white/10">
          <div>
            ...
            <p className="text-xs text-gray-400 font-mono mt-0.5">
              ID: {submission.id} â€¢ {submission.created_at ? new Date(submission.created_at).toLocaleString() : "N/A"}
            </p>
          </div>
        ...
        <div className="p-6 overflow-y-auto flex flex-col gap-4 divide-y divide-white/5">
          {errorMsg && (
            <div className="p-3 text-xs font-bold text-center text-red-400 bg-orange-500/10 border border-red-500/30 rounded-lg">
              âš ï¸ {errorMsg}
            </div>
          )}
        ...
        <div className="p-4 border-t border-white/10 flex items-center justify-between">
          <button
            ...
            className="px-3.5 py-2 text-xs font-semibold text-red-400 bg-orange-500/15 border border-red-500/30 hover:bg-orange-500/25 rounded-lg transition-colors"
          >
            Delete Submission
          </button>
